		...
		starlight({
			...
			sidebar: [
				...
				},
				{
					...
					items: [
						{ label: 'Übersicht', slug: '02-eva-prinzip/index' },
				...
				},
				{
					...
					items: [
						{ label: 'Übersicht', slug: '03-cpu-architektur/index' },
				...
				},
				{
					...
					items: [
						{ label: 'Übersicht', slug: '04-mainboard-chipsatz/index' },
